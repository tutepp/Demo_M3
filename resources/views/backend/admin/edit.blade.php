...
<section class="checkout spad">
    <div class="container">
        <div class="checkout__form">
            <h4 style="color: #7fad39">Cập nhật sản phẩm</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" placeholder="Tên sản phẩm" name="name_product" value="{{ $product->name_product }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="date" placeholder="Ngày nhập hàng" name="import_date" value="{{ $product->import_date }} ">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Giá sản phẩm<span>*</span></p>
                                        <input type="text" placeholder="Giá sản phẩm" name="price" value="{{ $product->price }} ">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" placeholder="Số lượng" name="total_product" value="{{ $product->total_product }} ">
                                    </div>
                                </div>
                            </div>
                            <div class="checkout__input">
                                <p>Mô tả<span>*</span></p>
                                <input type="text" placeholder="Mô tả" name="description" value="{{ $product->description }} ">
                            </div>
                            <div class="checkout__input">
