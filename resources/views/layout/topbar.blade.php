...
<head>
    ...
    <title>Phụ Kiện PC | CT COMPUTER</title>
...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="#"><img src="{{asset('storage/img/logo.png')}}" alt="a"></a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    ...
                    <div class="header__cart__price"><span>Giỏ Hàng </span></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="hero__item set-bg" data-setbg="{{asset('storage')}}/img/hero/banner.jpg">
                    <div class="hero__text">
                        ...
                        <h2>CT <br />COMPUTER</h2>
                        <p>Địa chỉ: Trần Thành Ngọ - Kiến An - HP </p>
                        <a href="#" class="primary-btn">Tìm hiểu thêm</a>
                    </div>
                </div>
            </div>
        </div>
